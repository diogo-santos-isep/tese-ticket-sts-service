        ...
        internal static IEnumerable<Client> GetClients()
        {
            return new List<Client>(){
                new Client{
                    ...
                    AllowedScopes = { "configuration","user","department", "ticket", "ticket.list", "ticket.notes", "ticket.history", "ticket.chat" },
                    ...
                    ClientName = "Back Office Ticket Application",
                    AllowedGrantTypes = GrantTypes.ClientCredentials,
                    AllowedScopes = { "department","configuration","ticket.client", "ticket.create", "ticket.chat"},
                    RedirectUris = {"http://localhost:4200/auth-callback"},
                    PostLogoutRedirectUris = {"http://localhost:4200/"},
                    AllowedCorsOrigins = {"http://localhost:4200"},
                    AllowAccessTokensViaBrowser = true,
